...
const Profile = () => {
  ...
  const handleUpdateProfile = async () => {
    try {
      ...
      const response = await axios.put("http://localhost:8000/user/profile", updateData, {
        headers: { Authorization: `Bearer ${token}` }
      });
          ...
          >
            <div id="profile-section">
              ...
              <div className="form-group">
                <label id="label" style={{ marginBottom: "5px" }}>Role</label>
                <select
                  id="role"
                  value={role}
            ...
            <div id="profile-section">
              ...
              <div className="form-group">
                <label id="label" style={{ marginBottom: "5px" }}>Bio</label>
                <textarea
                  id="bio-textarea"
